...
open class OHCubeView: UIScrollView, UIScrollViewDelegate{
    ...
    fileprivate func applyShadowForView(_ view: UIView, index: Int) {
        ...
        let r1 = frameFor(contentOffset, size: self.frame.size)
        let r2 = frameFor(CGPoint(x: CGFloat(index)*w, y: 0),
    ...
    fileprivate func frameFor(_ origin: CGPoint, size: CGSize) -> CGRect {
